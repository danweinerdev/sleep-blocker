//! The two D-Bus inhibitor primitives: [`Inhibitor`] for system sleep via
//! systemd-logind, and [`ScreenInhibitor`] for screen blanking and locking via
//! `org.freedesktop.ScreenSaver`. See the crate root for how they differ.
